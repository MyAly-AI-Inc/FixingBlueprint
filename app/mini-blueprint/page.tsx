        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            {faqItems.map((item, idx) => (
              <div key={idx} className="bg-gray-800/50 border-gray-700/50 rounded-lg mb-3">
                <div className="p-4 text-lg text-white hover:no-underline">
                  <HelpCircle className="h-5 w-5 text-blue-400 mr-3 inline-block" />
                  {item.q}
                </div>
                <div className="p-4 pt-0 text-blue-200">{item.a}</div>
              </div>
            ))}
          </div>
        </div>
